  ...
  'once started': {
    ...
    'attach console': {
      'check coinbase': function() {
        let out = testUtils.ghucExecJs(this.inst.dataDir, `huc.coinbase`);
    ...
    'rpc': {
      before: function() {
        this.webu = new Webu();
        this.webu.setProvider(
          new this.webu.providers.HttpProvider(`http://localhost:8545`));
      },
      'get coinbase': function() {
        this.webu.huc.coinbase.should.eql(`${this.inst.account}`);
      },
    },
  },
};
